function [SLM0,Energy] =  GenerateHologram(Psi1,n_x,n_y,X,Y)
...
%parameters for the added blazed grating to spatially shift the desired spectrum in k-space off-axis and filter it  
nx = 300;
ny = 300;
gy=ny/(2*n_x*8e-6);
gx=nx/(2*n_y*8e-6);
